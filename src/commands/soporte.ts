...
export default new Command('soporte', async (caller, cmd) => {
	const helpEmbed = new MessageEmbed()
		...
		.setFooter({ text: 'Administración | Kirinuxx Stars', iconURL: 'https://media.discordapp.net/attachments/936591912079618089/962657499046092830/a_e0b6b35c7b24c290a92c0fc22947c0d7.gif' });
